...
var format_DivaaTrst_38 = new ol.format.GeoJSON();
var features_DivaaTrst_38 = format_DivaaTrst_38.readFeatures(json_DivaaTrst_38, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_DivaaTrst_38 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_DivaaTrst_38.addFeatures(features_DivaaTrst_38);
var lyr_DivaaTrst_38 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_DivaaTrst_38, 
                style: style_DivaaTrst_38,
                interactive: false,
                title: '<img src="styles/legend/DivaaTrst_38.png" /> Divača-Trst '
            });
...
var format_MariborMurskaSobota_46 = new ol.format.GeoJSON();
var features_MariborMurskaSobota_46 = format_MariborMurskaSobota_46.readFeatures(json_MariborMurskaSobota_46, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_MariborMurskaSobota_46 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_MariborMurskaSobota_46.addFeatures(features_MariborMurskaSobota_46);
var lyr_MariborMurskaSobota_46 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_MariborMurskaSobota_46, 
                style: style_MariborMurskaSobota_46,
                interactive: false,
                title: '<img src="styles/legend/MariborMurskaSobota_46.png" /> Maribor-Murska Sobota '
            });
...
var group_Vizija2050 = new ol.layer.Group({
                                layers: [lyr_GrobelnoPragersko_35,lyr_ZagorjeCelje_36,lyr_KresniceZagorje_37,lyr_DivaaTrst_38,lyr_BeltinciLendava_39,lyr_LjubljanaDivaa_40,lyr_empeterPragersko_41,lyr_Celjepostaja_42,lyr_LevecCelje_43,lyr_LjubljanaCelje_44,lyr_Zagorjeempeter_45,lyr_MariborMurskaSobota_46,],
                                title: "Vizija 2050+"});
var group_AdriaA = new ol.layer.Group({
                                layers: [lyr_DivaaTri_34,],
                                title: "Adria-A"});
var group_VZP = new ol.layer.Group({
                                layers: [lyr_NavezavaZasavjeCelje_31,lyr_LjubljanaZidaniMost_32,lyr_LjubljanaDivaa_33,],
                                title: "VZP"});
var group_CIP1982 = new ol.layer.Group({
                                layers: [lyr_ZidaniMostDobova_29,lyr_LjubljanaZidaniMost_30,],
                                title: "CIP 1982"});
...
lyr_OpenStreetMap_0.setVisible(true);lyr_Esritopo_1.setVisible(true);lyr_Esrisatelit_2.setVisible(true);lyr_Carto_light_nolabels_3.setVisible(true);lyr_Drave_4.setVisible(true);lyr_IT_5.setVisible(false);lyr_AT_6.setVisible(false);lyr_HU_7.setVisible(false);lyr_HR_8.setVisible(false);lyr_Slovenija_9.setVisible(false);lyr_Kulturna_dediscina_10.setVisible(false);lyr_Natura_2000_11.setVisible(false);lyr_VVO_dravni_nivo_12.setVisible(false);lyr_VVO_obcinski_nivo_13.setVisible(false);lyr_CesteACinHC_14.setVisible(true);lyr_Obstojeeproge_15.setVisible(true);lyr_Obstojeepostaje_16.setVisible(true);lyr_DivaaKoper2tir_17.setVisible(true);lyr_PredorZalogBrezovica_18.setVisible(false);lyr_Optimiziranipredori_19.setVisible(false);lyr_Vzhodnojunaobvoznica_20.setVisible(false);lyr_Severnozahodnaobvoznica_21.setVisible(false);lyr_LJDI_22.setVisible(true);lyr_LJMB_23.setVisible(true);lyr_Dolenjskaproga_24.setVisible(true);lyr_DomaleKranjZlatoPolje_25.setVisible(true);lyr_MosteDomale_26.setVisible(true);lyr_Zahodnaobvoznaproga_27.setVisible(true);lyr_Kamnikaproga_28.setVisible(true);lyr_ZidaniMostDobova_29.setVisible(true);lyr_LjubljanaZidaniMost_30.setVisible(true);lyr_NavezavaZasavjeCelje_31.setVisible(true);lyr_LjubljanaZidaniMost_32.setVisible(true);lyr_LjubljanaDivaa_33.setVisible(true);lyr_DivaaTri_34.setVisible(true);lyr_GrobelnoPragersko_35.setVisible(true);lyr_ZagorjeCelje_36.setVisible(true);lyr_KresniceZagorje_37.setVisible(true);lyr_DivaaTrst_38.setVisible(true);lyr_BeltinciLendava_39.setVisible(true);lyr_LjubljanaDivaa_40.setVisible(true);lyr_empeterPragersko_41.setVisible(true);lyr_Celjepostaja_42.setVisible(true);lyr_LevecCelje_43.setVisible(true);lyr_LjubljanaCelje_44.setVisible(true);lyr_Zagorjeempeter_45.setVisible(true);lyr_MariborMurskaSobota_46.setVisible(true);lyr_NavezavaBrnikFraport_47.setVisible(true);lyr_NovagorenjskaprogaV2015_48.setVisible(true);lyr_KoridorskeS2_49.setVisible(true);
var layersList = [group_Podloge,group_Zalednikoridorjihitrihprog,group_Okoljeinprostor,group_Obstojeeomreje,group_LV,group_PIkrajanjepotovalnihasov,group_RegioLURR2,group_CIP1982,group_VZP,group_AdriaA,group_Vizija2050,lyr_NavezavaBrnikFraport_47,lyr_NovagorenjskaprogaV2015_48,lyr_KoridorskeS2_49];
...
lyr_ZidaniMostDobova_29.set('fieldAliases', {'NO': 'NO', 'FROMNODENO': 'FROMNODENO', 'TONODENO': 'TONODENO', 'LENGTH': 'LENGTH', 'R_NO': 'R_NO', 'R_FROMNO~1': 'R_FROMNO~1', 'R_TONODENO': 'R_TONODENO', 'R_LENGTH': 'R_LENGTH', });
lyr_LjubljanaZidaniMost_30.set('fieldAliases', {'NO': 'NO', 'FROMNODENO': 'FROMNODENO', 'TONODENO': 'TONODENO', 'LENGTH': 'LENGTH', 'R_NO': 'R_NO', 'R_FROMNO~1': 'R_FROMNO~1', 'R_TONODENO': 'R_TONODENO', 'R_LENGTH': 'R_LENGTH', });
...
lyr_DivaaTrst_38.set('fieldAliases', {'Tipodseka': 'Tipodseka', 'Length': 'Length', });
...
lyr_MariborMurskaSobota_46.set('fieldAliases', {'qc_id': 'qc_id', 'tip odseka': 'tip odseka', 'length': 'length', });
...
lyr_ZidaniMostDobova_29.set('fieldImages', {'NO': 'Range', 'FROMNODENO': 'Range', 'TONODENO': 'Range', 'LENGTH': 'TextEdit', 'R_NO': 'Range', 'R_FROMNO~1': 'Range', 'R_TONODENO': 'Range', 'R_LENGTH': 'TextEdit', });
lyr_LjubljanaZidaniMost_30.set('fieldImages', {'NO': 'Range', 'FROMNODENO': 'Range', 'TONODENO': 'Range', 'LENGTH': 'TextEdit', 'R_NO': 'Range', 'R_FROMNO~1': 'Range', 'R_TONODENO': 'Range', 'R_LENGTH': 'TextEdit', });
...
lyr_DivaaTrst_38.set('fieldImages', {'Tipodseka': '', 'Length': '', });
...
lyr_MariborMurskaSobota_46.set('fieldImages', {'qc_id': '', 'tip odseka': '', 'length': '', });
...
lyr_DivaaTrst_38.set('fieldLabels', {});
...
lyr_MariborMurskaSobota_46.set('fieldLabels', {});
