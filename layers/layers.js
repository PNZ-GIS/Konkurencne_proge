...
var format_MariborZagreb_35 = new ol.format.GeoJSON();
var features_MariborZagreb_35 = format_MariborZagreb_35.readFeatures(json_MariborZagreb_35, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_MariborZagreb_35 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_MariborZagreb_35.addFeatures(features_MariborZagreb_35);
var lyr_MariborZagreb_35 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_MariborZagreb_35, 
                style: style_MariborZagreb_35,
                interactive: false,
                title: '<img src="styles/legend/MariborZagreb_35.png" /> Maribor-Zagreb'
            });
var format_DivaaTrst_36 = new ol.format.GeoJSON();
var features_DivaaTrst_36 = format_DivaaTrst_36.readFeatures(json_DivaaTrst_36, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_DivaaTrst_36 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_DivaaTrst_36.addFeatures(features_DivaaTrst_36);
var lyr_DivaaTrst_36 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_DivaaTrst_36, 
                style: style_DivaaTrst_36,
                interactive: false,
                title: '<img src="styles/legend/DivaaTrst_36.png" /> Divača-Trst '
            });
var format_MariborMurskaSobota_37 = new ol.format.GeoJSON();
var features_MariborMurskaSobota_37 = format_MariborMurskaSobota_37.readFeatures(json_MariborMurskaSobota_37, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_MariborMurskaSobota_37 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_MariborMurskaSobota_37.addFeatures(features_MariborMurskaSobota_37);
var lyr_MariborMurskaSobota_37 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_MariborMurskaSobota_37, 
                style: style_MariborMurskaSobota_37,
                interactive: false,
                title: '<img src="styles/legend/MariborMurskaSobota_37.png" /> Maribor-Murska Sobota '
            });
...
var format_NavezavaBrnik_45 = new ol.format.GeoJSON();
var features_NavezavaBrnik_45 = format_NavezavaBrnik_45.readFeatures(json_NavezavaBrnik_45, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_NavezavaBrnik_45 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_NavezavaBrnik_45.addFeatures(features_NavezavaBrnik_45);
var lyr_NavezavaBrnik_45 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_NavezavaBrnik_45, 
                style: style_NavezavaBrnik_45,
                interactive: true,
                title: '<img src="styles/legend/NavezavaBrnik_45.png" /> Navezava Brnik'
            });
var format_NovagorenjskaprogaV2015_46 = new ol.format.GeoJSON();
var features_NovagorenjskaprogaV2015_46 = format_NovagorenjskaprogaV2015_46.readFeatures(json_NovagorenjskaprogaV2015_46, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_NovagorenjskaprogaV2015_46 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_NovagorenjskaprogaV2015_46.addFeatures(features_NovagorenjskaprogaV2015_46);
var lyr_NovagorenjskaprogaV2015_46 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_NovagorenjskaprogaV2015_46, 
                style: style_NovagorenjskaprogaV2015_46,
                interactive: false,
                title: '<img src="styles/legend/NovagorenjskaprogaV2015_46.png" /> Nova gorenjska proga (ŠV 2015)'
            });
var format_KoridorskeS2_47 = new ol.format.GeoJSON();
var features_KoridorskeS2_47 = format_KoridorskeS2_47.readFeatures(json_KoridorskeS2_47, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_KoridorskeS2_47 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_KoridorskeS2_47.addFeatures(features_KoridorskeS2_47);
var lyr_KoridorskeS2_47 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_KoridorskeS2_47, 
                style: style_KoridorskeS2_47,
                interactive: false,
                title: '<img src="styles/legend/KoridorskeS2_47.png" /> Koridorske S2'
            });
var group_Vizija = new ol.layer.Group({
                                layers: [lyr_MariborZagreb_35,lyr_DivaaTrst_36,lyr_MariborMurskaSobota_37,lyr_BeltinciLendava_38,lyr_LjubljanaDivaa_39,lyr_empeterPragersko_40,lyr_Celjepostaja_41,lyr_LevecCelje_42,lyr_LjubljanaCelje_43,lyr_Zagorjeempeter_44,],
                                title: "Vizija"});
...
lyr_OpenStreetMap_0.setVisible(true);lyr_Esritopo_1.setVisible(true);lyr_Esrisatelit_2.setVisible(true);lyr_Carto_light_nolabels_3.setVisible(true);lyr_Drave_4.setVisible(true);lyr_IT_5.setVisible(false);lyr_AT_6.setVisible(false);lyr_HU_7.setVisible(false);lyr_HR_8.setVisible(false);lyr_Slovenija_9.setVisible(false);lyr_Kulturna_dediscina_10.setVisible(false);lyr_Natura_2000_11.setVisible(false);lyr_VVO_dravni_nivo_12.setVisible(false);lyr_VVO_obcinski_nivo_13.setVisible(false);lyr_Obstojeeproge_14.setVisible(true);lyr_Obstojeepostaje_15.setVisible(true);lyr_DivaaKoper_16.setVisible(true);lyr_PredorZalogBrezovica_17.setVisible(false);lyr_Optimiziranipredori_18.setVisible(false);lyr_Vzhodnojunaobvoznica_19.setVisible(false);lyr_Severnozahodnaobvoznica_20.setVisible(false);lyr_GrobelnoPragersko_21.setVisible(true);lyr_KresniceZagorje_22.setVisible(true);lyr_ZagorjeCelje_23.setVisible(true);lyr_BorovnicaPostojnaDivaa_24.setVisible(true);lyr_Dolenjskaproga_25.setVisible(true);lyr_DomaleKranjZlatoPolje_26.setVisible(true);lyr_MosteDomale_27.setVisible(true);lyr_Zahodnaobvoznaproga_28.setVisible(true);lyr_Kamnikaproga_29.setVisible(true);lyr_NakazanasmerZidaniMostDobova_30.setVisible(true);lyr_NavezavaZasavjeCelje_31.setVisible(true);lyr_LjubljanaZidaniMost_32.setVisible(true);lyr_LjubljanaDivaa_33.setVisible(true);lyr_DivaaTri_34.setVisible(true);lyr_MariborZagreb_35.setVisible(true);lyr_DivaaTrst_36.setVisible(true);lyr_MariborMurskaSobota_37.setVisible(true);lyr_BeltinciLendava_38.setVisible(true);lyr_LjubljanaDivaa_39.setVisible(true);lyr_empeterPragersko_40.setVisible(true);lyr_Celjepostaja_41.setVisible(true);lyr_LevecCelje_42.setVisible(true);lyr_LjubljanaCelje_43.setVisible(true);lyr_Zagorjeempeter_44.setVisible(true);lyr_NavezavaBrnik_45.setVisible(true);lyr_NovagorenjskaprogaV2015_46.setVisible(true);lyr_KoridorskeS2_47.setVisible(true);
var layersList = [group_Podloge,group_Zalednikoridorjihitrihprog,group_Okoljeinprostor,group_Obstojeeomreje,group_LV,group_PIkrajanjepotovalnihasov,group_RegioLURR2,group_VZP,group_AdriaA,group_Vizija,lyr_NavezavaBrnik_45,lyr_NovagorenjskaprogaV2015_46,lyr_KoridorskeS2_47];
...
lyr_MariborZagreb_35.set('fieldAliases', {'descriptio': 'descriptio', 'Length': 'Length', });
lyr_DivaaTrst_36.set('fieldAliases', {'Tipodseka': 'Tipodseka', 'Length': 'Length', });
lyr_MariborMurskaSobota_37.set('fieldAliases', {'qc_id': 'qc_id', 'tip odseka': 'tip odseka', 'length': 'length', });
...
lyr_NavezavaBrnik_45.set('fieldAliases', {'FID': 'FID', });
lyr_NovagorenjskaprogaV2015_46.set('fieldAliases', {'NO': 'NO', });
lyr_KoridorskeS2_47.set('fieldAliases', {'NO': 'NO', 'R_NO': 'R_NO', });
...
lyr_MariborZagreb_35.set('fieldImages', {'descriptio': '', 'Length': '', });
lyr_DivaaTrst_36.set('fieldImages', {'Tipodseka': '', 'Length': '', });
lyr_MariborMurskaSobota_37.set('fieldImages', {'qc_id': '', 'tip odseka': '', 'length': '', });
...
lyr_NavezavaBrnik_45.set('fieldImages', {'FID': '', });
lyr_NovagorenjskaprogaV2015_46.set('fieldImages', {'NO': '', });
lyr_KoridorskeS2_47.set('fieldImages', {'NO': '', 'R_NO': '', });
...
lyr_MariborZagreb_35.set('fieldLabels', {});
lyr_DivaaTrst_36.set('fieldLabels', {});
lyr_MariborMurskaSobota_37.set('fieldLabels', {});
...
lyr_NavezavaBrnik_45.set('fieldLabels', {'FID': 'no label', });
lyr_NovagorenjskaprogaV2015_46.set('fieldLabels', {'NO': 'no label', });
lyr_KoridorskeS2_47.set('fieldLabels', {'NO': 'no label', 'R_NO': 'no label', });
lyr_KoridorskeS2_47.on('precompose', function(evt) {
